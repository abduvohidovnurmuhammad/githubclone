...
const index = () => {
    ...
    const [value, setValue] = useState(localStorage.getItem("key") || "abduvohidovnurmuhammad");
    ...
    return (
        <>
            <header className='header'>
                <nav className="nav">
                    <span className='nav__left-menu' onClick={() => menuClick()}> <i className="bi bi-list"></i> </span>
                    <div className="nav__left">
                        <span className='nav__left-github'> <i className="bi bi-github"></i>
                        </span>
                    ...
                    <div className="nav__right">
                        <span className="nav__right-bell"> <i className="bi bi-bell"></i> </span>
                        <div className="nav__right--icons">
                            <span className="nav__right--icons-plus"> <i className="bi bi-plus-lg"></i> </span>
                            <span className="nav__right--icons-triangle"> <i className="bi bi-caret-down-fill"></i> </span>
                        </div>
                        <span className='nav__right--round'>
                          
                            <img className='nav__right--round-img' src={array.avatar_url} alt="avatar" />
                            <span className='nav__right--round-triangle'> <i className="bi bi-caret-down-fill"></i> </span>
                        </span>
                    </div>
                ...
                <div className={state ? "nav__menu d-block" : "d-none"}>
                    ...
                    <div>
                        <div className='nav__round'>
                            <img src="https://avatars.githubusercontent.com/u/115654496?v=4" alt="img" className="nav__round-img" />
                            <p className='nav__round-user'>abduvohidovnurmuhammad</p>
                        </div>
                        <hr className='nav__round-hr' />
                    </div>

                    <div className='nav__sign'>
                        <span className='nav__sign-icon'> <i className="bi bi-box-arrow-right"></i> </span>
